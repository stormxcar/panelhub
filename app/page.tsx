...
export default async function Home() {
  ...
  return (
    <main>
      ...
      <HeroGallery slides={heroSlides} phone={site.contact.phone} phoneDisplay={site.contact.phoneDisplay} title={managedHome?.heroTitle} description={managedHome?.heroDescription} />

...
const services = [
  ["Nhà panel dân dụng", "Nhà ở, homestay gọn nhẹ, hoàn thiện nhanh theo nhu cầu sử dụng.", "Nhà ở · Homestay", "residential-panel-house"],
  ["Nhà xưởng tiền chế", "Kết cấu khẩu độ lớn, dễ mở rộng và kiểm soát tiến độ lắp dựng.", "Sản xuất · Kho bãi", "industrial-panel-factory"],
  ["Văn phòng panel", "Không gian làm việc sạch, linh hoạt cho công trình tạm hoặc cố định.", "Văn phòng · Nhà mẫu", "panel-office-building"],
  ["Kho lạnh panel PU", "Giải pháp giữ nhiệt và kín khí cho thực phẩm, dược phẩm, logistics.", "Thực phẩm · Dược phẩm", "cold-storage-panel"],
  ["Nhà điều hành", "Module thi công nhanh, thuận tiện giám sát và vận hành công trường.", "Công trường · Dự án", "panel-control-room"],
  ["Cải tạo mở rộng", "Bổ sung không gian sử dụng mà giảm tối đa ảnh hưởng đến vận hành hiện hữu.", "Mở rộng · Cải tạo", "renovation-panel-extension"]
];

const processSteps = [
  ["Khảo sát", "Đo mặt bằng, kiểm tra nền móng và điều kiện vận chuyển vật tư.", "survey-panel-site"],
  ["Tư vấn", "Xác định nhu cầu sử dụng, mức đầu tư và loại panel phù hợp.", "panel-consultation"],
  ["Thiết kế", "Chốt mặt bằng, khẩu độ khung và giải pháp kỹ thuật.", "panel-design-plan"],
  ["Báo giá", "Bóc tách vật tư, tiến độ và phạm vi hoàn thiện minh bạch.", "panel-quotation"],
  ["Thi công", "Gia công khung tại xưởng, lắp dựng và lắp panel tại công trình.", "panel-wall-install"],
  ["Bàn giao", "Kiểm tra mối nối, phụ kiện, vệ sinh và nghiệm thu công trình.", "panel-handover"],
  ["Bảo hành", "Hướng dẫn vận hành và tiếp nhận yêu cầu hỗ trợ sau bàn giao.", "panel-warranty"]
];

const projects: PortfolioProject[] = [
  { title: "Nhà ở panel 120m²", category: "Nhà ở", description: "Khung thép và panel EPS hoàn thiện gọn cho gia đình trẻ.", image: "https://picsum.photos/seed/panel-home/900/680", area: "120 m²", duration: "18 ngày", material: "EPS", location: "Bình Dương" },
  { title: "Homestay ven đô", category: "Nhà ở", description: "Module lưu trú mở rộng linh hoạt, tối ưu tiến độ khai thác.", image: "https://picsum.photos/seed/panel-homestay/900/680", area: "180 m²", duration: "25 ngày", material: "EPS", location: "Đồng Nai" },
  { title: "Nhà xưởng 620m²", category: "Nhà xưởng", description: "Khung thép tiền chế, mái panel Rockwool cho xưởng sản xuất.", image: "https://picsum.photos/seed/panel-factory/900/680", area: "620 m²", duration: "38 ngày", material: "Rockwool", location: "TP.HCM" },
  { title: "Xưởng gia công mở rộng", category: "Nhà xưởng", description: "Không gian sản xuất mở rộng theo nhịp kết cấu hiện hữu.", image: "https://picsum.photos/seed/panel-workshop/900/680", area: "450 m²", duration: "30 ngày", material: "EPS", location: "Long An" },
  { title: "Kho lạnh thực phẩm", category: "Kho lạnh", description: "Panel PU, xử lý kín khít mối nối cho khu lưu trữ nhiệt độ ổn định.", image: "https://picsum.photos/seed/panel-cold/900/680", area: "240 m²", duration: "21 ngày", material: "PU", location: "Bình Dương" },
  { title: "Văn phòng công trình", category: "Văn phòng", description: "Không gian điều hành lắp nhanh, dễ di dời khi thay đổi mặt bằng.", image: "https://picsum.photos/seed/panel-office/900/680", area: "96 m²", duration: "12 ngày", material: "EPS", location: "Đồng Nai" }
];
    ...
    <main>
      ...
      <section id="hero" className="hero">
        ...
        <div className="hero-media reveal">
          <div className="hero-main-photo"><Image src="https://picsum.photos/seed/panel-industrial-site/1180/900" alt="Nhà tiền chế panel đang thi công với khung thép" fill sizes="(max-width: 768px) 100vw, 50vw" priority /></div>
          <div className="hero-thumb hero-thumb-one"><Image src="https://picsum.photos/seed/panel-roof-install/520/420" alt="Lắp đặt mái panel cách nhiệt" fill sizes="220px" /></div>
          <div className="hero-thumb hero-thumb-two"><Image src="https://picsum.photos/seed/steel-frame-panel/520/420" alt="Khung thép tiền chế chuẩn bị lắp panel" fill sizes="240px" /></div>
      ...
      <section className="section services-section"><div className="section-stack reveal"><p className="kicker">Dịch vụ trọn gói</p><h2>Giải pháp panel theo đúng mô hình bạn đang vận hành</h2></div><div className="services-bento">{services.map(([title, description, tags, seed]) => <article className="service-card reveal" key={title}><Image src={`https://picsum.photos/seed/${seed}/760/560`} alt={title} fill sizes="(max-width: 768px) 82vw, 33vw" /><div><span>{tags}</span><h3>{title}</h3><p>{description}</p><a href="#lien-he">Tìm hiểu thêm <ArrowRight size={16} weight="bold" /></a></div></article>)}</div><SectionCta text="Chưa chắc loại panel nào phù hợp? Gửi nhu cầu để nhận phương án sơ bộ." /></section>

      <section id="cau-tao" className="section anatomy"><div className="anatomy-visual reveal"><Image src="https://picsum.photos/seed/panel-layer-cut/920/760" alt="Cấu tạo tấm panel cách nhiệt" fill sizes="(max-width: 900px) 100vw, 46vw" /></div><div className="anatomy-copy reveal"><p className="kicker">Tôn, lõi, tôn</p><h2>Cấu tạo tấm panel cách nhiệt cho công trình chắc và sạch</h2><p>Tấm panel gồm hai lớp tôn mạ màu kẹp lõi cách nhiệt. Lựa chọn lõi panel quyết định mức giữ nhiệt, chống cháy, cách âm và ngân sách.</p><div className="panel-types"><article><h3>Panel PU</h3><p>Giữ nhiệt tốt cho kho lạnh và không gian cần ổn định nhiệt.</p></article><article><h3>Panel EPS</h3><p>Chi phí hợp lý cho nhà ở, văn phòng và công trình phổ thông.</p></article><article><h3>Panel Rockwool</h3><p>Ưu tiên chống cháy, cách âm cho xưởng và khu kỹ thuật.</p></article></div></div></section>

      <section className="section process reveal"><div className="section-stack narrow"><p className="kicker">Quy trình rõ từng việc</p><h2>7 bước triển khai nhà panel từ khảo sát đến bảo hành</h2></div><div className="process-board"><div className="process-feature"><Image src="https://picsum.photos/seed/panel-process-feature/920/1120" alt="Quy trình thi công nhà panel" fill sizes="(max-width: 1080px) 100vw, 38vw" /><div className="process-feature-card"><span>7 bước</span><strong>Từ khảo sát đến bảo hành</strong></div></div><div className="process-masonry">{processSteps.map(([step, text, seed], index) => <article className="timeline-step" key={step}><div className="step-photo"><Image src={`https://picsum.photos/seed/${seed}/520/360`} alt={`${step} trong quy trình thi công`} fill sizes="(max-width: 760px) 82vw, 260px" /></div><span>{String(index + 1).padStart(2, "0")}</span><h3>{step}</h3><p>{text}</p></article>)}</div></div><SectionCta text="Bắt đầu với bước khảo sát miễn phí và phương án phù hợp mặt bằng." /></section>

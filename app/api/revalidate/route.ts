...
export async function POST(request: NextRequest) {
  ...
  ["sanity-home", "sanity-site-settings", "sanity-legal", "sanity-consultation-form", "sanity-articles", "sanity-service-pages"].forEach((tag) => revalidateTag(tag));
  const paths = ["/", "/chinh-sach-bao-mat", "/dieu-khoan-su-dung", "/bai-viet", "/cau-tao", "/quy-trinh", "/du-an", "/bao-gia"];
